import AlarmRecordItem from '@/pages/alarmManagers/components/alarmRecordItem';
import type { RecordData } from '@/pages/alarmManagers/components/alarmRecordItem/data';
