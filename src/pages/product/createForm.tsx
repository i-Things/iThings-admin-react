...
import { authModeForm, autoRegisterForm, deviceTypeFrom, netTypeForm } from '@/utils/const';
...
export const CreateForm: React.FC<Props> = ({ onCommit }) => {
  ...
  const formCommit = async (values: PRODUCT.productInfo) => {
    const body = values;
