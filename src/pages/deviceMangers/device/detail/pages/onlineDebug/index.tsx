import { debugType } from '@/pages/deviceMangers/device/detail/pages/onlineDebug/data';
import SendMsg from '@/pages/deviceMangers/device/detail/pages/onlineDebug/sendMsg';
