...
//     name: '产品',
//     icon: 'icon_system',
//     path: '/deviceManagers/products/index',
//     parentID: 2,
//     order: 1,
//     component: './deviceManagers/products/index.tsx',
//   },
//   {
//     id: 7,
//     name: '产品详情-${id}',
//     icon: 'icon_system',
//     hideInMenu: true,
//     path: '/deviceManagers/products/details/:id',
//     parentID: 2,
//     order: 2,
//     component: './deviceManagers/products/details/index.tsx',
//   },
//   {
//     id: 8,
//     name: '设备',
//     icon: 'icon_system',
//     path: '/deviceManagers/devices/index',
//     parentID: 2,
//     order: 3,
//     component: './deviceManagers/devices/index.tsx',
//   },
//   {
//     id: 9,
//     name: '设备详情-${id}',
//     icon: 'icon_system',
//     hideInMenu: true,
//     path: '/deviceManagers/devices/details/:id',
//     parentID: 2,
//     order: 3,
//     component: './deviceManagers/devices/details/index.tsx',
//   },
//   {
//     id: 10,
//     name: '用户管理',
    ...
    routes: [
      {
        ...
        routes: [
          {
            name: '产品',
            path: '/deviceManagers/products',
            component: './deviceManagers/products/index',
          },
          {
            name: '产品详情',
            hideInMenu: true,
            path: '/deviceManagers/products/details/:id',
            component: './deviceManagers/products/details/index',
          },
          {
            name: '设备',
            path: '/deviceManagers/devices',
            component: './deviceManagers/devices/index',
          },
          {
            name: '设备详情',
            hideInMenu: true,
            path: '/deviceManagers/devices/detail/:id',
            component: './deviceManagers/devices/details/index',
          },
        ],
      },
      {
